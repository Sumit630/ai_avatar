...
class AppThemeWrapper extends StatelessWidget {
  ...
  const AppThemeWrapper({super.key, this.builder});
...
extension TextStyleExtensions on TextStyle {
  ...
  TextStyle get black => textColor(AppColors.colorHendingColor);
  TextStyle get deemBlack => textColor(AppColors.colorDeemBlack);
  // TextStyle get grey => textColor(AppColors.gray);
  // TextStyle get themeColor => textColor(AppColors.themeColor);
